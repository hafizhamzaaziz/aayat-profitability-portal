...
import ExpensesPanel from "../cogs/expenses-panel";
...
export default async function ExpensesPage({
  ...
  if (!accountId) {
    return (
      <div className="space-y-4">
        <p className="text-slate-600">Select an account from the topbar context switcher to load expenses.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <ExpensesPanel accountId={account.id} canEdit={canEdit} currency={account.currency} />
    </div>
  );
}
